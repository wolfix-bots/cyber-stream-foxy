...
import { Menu, X, Flame, TrendingUp, Zap } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <Link to="/" className="flex items-center gap-2 flex-shrink-0">
          ...
          <div className="hidden sm:block">
            <span className="font-display text-lg font-bold text-neon-cyan glow-text-cyan tracking-widest">
              FOXY
            </span>
            <span className="font-display text-lg font-bold text-neon-magenta glow-text-magenta tracking-widest">
              STREAM
            </span>
          </div>
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-2 flex-shrink-0">
          ...
          <span className="px-2 py-0.5 text-xs font-display border border-neon-cyan/30 text-neon-cyan rounded-sm">
            FOXY TECH
          </span>
          <span className="px-2 py-0.5 text-xs font-display border border-neon-magenta/30 text-neon-magenta rounded-sm">
            CASPER TECH
          </span>
        </div>
